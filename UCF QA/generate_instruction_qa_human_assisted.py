            ...
            messages=[
                {
                    ...
                    "content":
                        ...
                        "The video summarization will be used for various applications regarding video surveillance scenarios, such as generating previews or summaries of video content for cctv camera operators, "
                        "creating highlights or summaries of criminal events, identifying the ocurrance or not of a crime, reasoning about the duality of victim and perpretator, etc. "
                        ...
                        "- The questions should accomplish one or more the following goals: General Scene Assessment, Identifying Key Events, Detailed Analysis of Actions, Identifying People and/or Animals and/or Objects Involved, Assessing Victim and Perpetrator Dynamics. "
                        "------"
                        "##SAMPLE QUESTIONS:"
